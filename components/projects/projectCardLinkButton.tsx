...
import { linkButtonTypes, TProjectCardLinkButtonSrc } from '../../types/project.type';

export interface IProjectCardLinkButtonProps {
  src: TProjectCardLinkButtonSrc;
}

const ProjectCardLinkButton: FC<IProjectCardLinkButtonProps> = ({ src: { url, type } }) => {
  return (
    <a className='btn-bg btn-bg-hover flex px-2 py-1 mb-2 mr-2 text-xs font-medium rounded-md' href={url} target='_blank' rel='noreferrer'>
